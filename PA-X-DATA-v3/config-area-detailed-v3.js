...
var FIELDS = [
		{
			...
			"GeMeOth":
				  { human: "other", areafilter: "0", type:"text", exclude:"0"},
			"GeLgbti": 
				  { human: "LGBTI references", areafilter: "0", type:"text", exclude:"0"},
			"GeLgbtiPos": 
				  { human: "Positive LGBTI references", areafilter: "0", type:"text", exclude:"0"},
			"GeLgbtiNeg": 
				  { human: "Negative LGBTI references", areafilter: "0", type:"text", exclude:"0"},
			"GeLgbti":
